...
🖥 [**바로가기(Web)**](https://github.com/goorm-fullstack/Introduce3355) / 📱 [**바로가기(App)**](http://cslab2.kku.ac.kr/~202023610/std/std.html)

<br />

## 🔍 프로젝트 개요
- **개발 목적:** CRUD 실습, 소프트 스킬 향상을 위한 협업 경험 쌓기
- **개발 기간:** 2023.06.24~2023.07.07(총 14일)
...
- `2023.06.24` firebase 프로젝트와 flutter 연동 확인, 동적 위젯을 사용하여 움직이는 위젯 구현  
- `2023.06.25` 메인화면 이동 애니메이션 구현, 러프 디자인 틀과 firebase 컬렉션 문서 필드 출력 확인
- `2023.06.26` 방명록 작성과 수정 삭제 구현 (코드 486줄)
- `2023.06.28` 조원 소개 페이지 초안 제작
- `2023.07.03` 안드로이드 위젯 제작
- `2023.07.05` firebase 필드 수정
- `2023.07.07` 로그인, 애니메이션, 피드백 수정 기능 추가
